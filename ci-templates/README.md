...
| **Validador de @imports**     | que todo `@import <ruta>` en ficheros de gobierno apunte a un fichero existente | el repo usa `@import` en `CLAUDE.md`/`AGENTS.md` | check_imports.py propio                                 | plantilla disponible                         |
...
# si ya ejecutaste setup/bootstrap-machine.ps1/.sh, este paso ya está hecho.
